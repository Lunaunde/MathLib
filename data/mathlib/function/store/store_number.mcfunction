...
$execute if score #after_exponent number matches 0 run scoreboard players add #$(operand)_digit number 1
$execute if score #after_exponent number matches 1 run scoreboard players add #$(operand)_digit_exponent number 1
